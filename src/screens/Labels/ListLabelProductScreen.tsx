...
const ListLabelProductScreen = () => {
    ...
    const fetchProducts = async () => {
        try {
            const response = await productService.getLabelPrinterItems(userId);
            ...
            [
                { text: 'Cancel', style: 'cancel' },
                {
                    ...
                    onPress: async () => {
                        try {
                            setLoading(true);
                            await productService.deleteLabelItem(id);
    ...
    const handleSaveEdit = async () => {
        ...
        try {
            ...
            await productService.updateLabelItem(editingProduct.id, payload);
