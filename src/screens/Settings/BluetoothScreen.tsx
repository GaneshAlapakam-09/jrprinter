        ...
        <View style={[s.statusBanner, { backgroundColor: t.successBg, borderColor: t.success }]}>
          ...
          <View style={{ flexDirection: 'row', gap: 8 }}>
            <TouchableOpacity style={s.smallBtn} onPress={async () => {
               try { await connectedDevice.write("Test Print Successful\n\n\n"); } catch(e) {}
            }}>
               <Text style={{ fontSize: 10, color: t.success, fontWeight: 'bold' }}>TEST</Text>
            </TouchableOpacity>
            <TouchableOpacity style={s.smallBtn} onPress={() => { /* assume handled in settings */ }}>
               <Text style={{ fontSize: 10, color: t.success, fontWeight: 'bold' }}>DEFAULT</Text>
            </TouchableOpacity>
          </View>
        </View>
      )}
...
const s = StyleSheet.create({
  ...
  smallBtn: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6, borderWidth: 1, borderColor: 'rgba(5, 150, 105, 0.5)' },
});
